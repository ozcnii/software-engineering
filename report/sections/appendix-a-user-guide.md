...
Справочная информация о системе оформлена как иллюстрированное руководство пользователя и разделена на две страницы — для администратора и для игрока. Из меню администратора в новой вкладке браузера открывается справка администратора (см. рисунок А.8). Она содержит пошаговое описание работы со скриншотами: список лабиринтов, создание лабиринта по шагам мастера (параметры, расстановка входа и выхода, правка сетки, сохранение) и удаление.

![Рисунок А.8 – Страница справки](../images/help-admin.png)

Рисунок А.8 – Страница справки
...
Справочная информация и сведения о разработчиках открываются игроку по тем же пунктам меню, что и администратору. Из меню игрока в новой вкладке браузера открывается отдельная справка игрока (см. рисунок А.14). Она описывает выбор лабиринта, ручное прохождение, автоматическое решение и завершение уровня со статистикой. Сведения о разработчиках открываются в модальном окне поверх текущего экрана.

![Рисунок А.14 – Страница справки](../images/help-player.png)

Рисунок А.14 – Страница справки
