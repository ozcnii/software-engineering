...
| Labyrinth generation | Not started | API-05, ADM-CREATE-05, ADM-CREATE-07 |
| Labyrinth persistence | Not started | API-03, API-04, API-06, API-07 |
| Difficulty calculation | Not started | API-03 |
| Player screen | Not started | PLAYER-01..PLAYER-04 |
| Manual movement | Not started | PLAYER-05..PLAYER-08 |
| Auto-solve BFS/DFS | Not started | AUTO-01..AUTO-05, API-08, API-09 |
